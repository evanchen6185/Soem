...
/** @defgroup PHY_Read_write_Timeouts 
  * @{
  */ 
//#define PHY_READ_TO                     ((uint32_t)0x0004FFFF)   //13s
//#define PHY_WRITE_TO                    ((uint32_t)0x0004FFFF)   //13s
#define PHY_READ_TO                     ((uint32_t)0x00013FFF)   //3s
#define PHY_WRITE_TO                    ((uint32_t)0x00013FFF)   //3s
//#define PHY_READ_TO                     ((uint32_t)0x00006AAA)   //1s
//#define PHY_WRITE_TO                    ((uint32_t)0x00006AAA)   //1s
/**
  * @}
  */
