...
#line 25 "..\\FWLIB\\STM32F4x7_ETH_Driver\\src\\stm32f4x7_eth.c"
#line 26 "..\\FWLIB\\STM32F4x7_ETH_Driver\\src\\stm32f4x7_eth.c"
...
#line 27 "..\\FWLIB\\STM32F4x7_ETH_Driver\\src\\stm32f4x7_eth.c"
...
#line 93 "..\\FWLIB\\STM32F4x7_ETH_Driver\\src\\stm32f4x7_eth.c"
...
void ETH_DeInit(void)
{
  RCC_AHB1PeriphResetCmd(((uint32_t)0x02000000), ENABLE);
  RCC_AHB1PeriphResetCmd(((uint32_t)0x02000000), DISABLE);
}
...
void ETH_StructInit(ETH_InitTypeDef* ETH_InitStruct)
{
  ...
  ETH_InitStruct->ETH_AutoNegotiation = ((uint32_t)0x00000001); 			
   
  ETH_InitStruct->ETH_Watchdog = ((uint32_t)0x00000000);										 	
   					
  ETH_InitStruct->ETH_Jabber = ((uint32_t)0x00000000);       									
   
  ETH_InitStruct->ETH_InterFrameGap = ((uint32_t)0x00000000);  					
    
  ETH_InitStruct->ETH_CarrierSense = ((uint32_t)0x00000000); 						
   
  ETH_InitStruct->ETH_Speed = ((uint32_t)0x00004000); 														
   
  ETH_InitStruct->ETH_ReceiveOwn = ((uint32_t)0x00000000);                	
    
  ETH_InitStruct->ETH_LoopbackMode = ((uint32_t)0x00000000); 						
   
  ETH_InitStruct->ETH_Mode = ((uint32_t)0x00000800);   											
   
  ETH_InitStruct->ETH_ChecksumOffload = ((uint32_t)0x00000000);   		
    
  ETH_InitStruct->ETH_RetryTransmission = ((uint32_t)0x00000000);   
   
  ETH_InitStruct->ETH_AutomaticPadCRCStrip = ((uint32_t)0x00000000);  
    
  ETH_InitStruct->ETH_BackOffLimit = ((uint32_t)0x00000000);     						
   
  ETH_InitStruct->ETH_DeferralCheck = ((uint32_t)0x00000000);          
    
  ETH_InitStruct->ETH_ReceiveAll = ((uint32_t)0x00000000);								
   
  ETH_InitStruct->ETH_SourceAddrFilter = ((uint32_t)0x00000000);   	
   
  ETH_InitStruct->ETH_PassControlFrames = ((uint32_t)0x00000040); 
   
  ETH_InitStruct->ETH_BroadcastFramesReception = ((uint32_t)0x00000020);
   
  ETH_InitStruct->ETH_DestinationAddrFilter = ((uint32_t)0x00000000);			
   
  ETH_InitStruct->ETH_PromiscuousMode = ((uint32_t)0x00000000);			
   
  ETH_InitStruct->ETH_MulticastFramesFilter = ((uint32_t)0x00000000);  
   
  ETH_InitStruct->ETH_UnicastFramesFilter = ((uint32_t)0x00000000);     	
   
  ETH_InitStruct->ETH_HashTableHigh = 0x0;   											
  ETH_InitStruct->ETH_HashTableLow = 0x0;                     		
   
  ETH_InitStruct->ETH_PauseTime = 0x0;                 					
  ETH_InitStruct->ETH_ZeroQuantaPause = ((uint32_t)0x00000080);            
  ETH_InitStruct->ETH_PauseLowThreshold = ((uint32_t)0x00000000);         
  ETH_InitStruct->ETH_UnicastPauseFrameDetect = ((uint32_t)0x00000000);   
  ETH_InitStruct->ETH_ReceiveFlowControl = ((uint32_t)0x00000000);        
  ETH_InitStruct->ETH_TransmitFlowControl = ((uint32_t)0x00000000);
   
  ETH_InitStruct->ETH_VLANTagComparison = ((uint32_t)0x00000000);          
  ETH_InitStruct->ETH_VLANTagIdentifier = 0x0;          
  
   

   
  ETH_InitStruct->ETH_DropTCPIPChecksumErrorFrame = ((uint32_t)0x04000000); 
   
  ETH_InitStruct->ETH_ReceiveStoreForward = ((uint32_t)0x02000000);       
   
  ETH_InitStruct->ETH_FlushReceivedFrame = ((uint32_t)0x00000000); 
   
  ETH_InitStruct->ETH_TransmitStoreForward = ((uint32_t)0x00200000);   	
   
  ETH_InitStruct->ETH_TransmitThresholdControl = ((uint32_t)0x00000000);  
   
  ETH_InitStruct->ETH_ForwardErrorFrames = ((uint32_t)0x00000000);   
   
  ETH_InitStruct->ETH_ForwardUndersizedGoodFrames = ((uint32_t)0x00000000); 
   
  ETH_InitStruct->ETH_ReceiveThresholdControl = ((uint32_t)0x00000000);    
  
                            
  ETH_InitStruct->ETH_SecondFrameOperate = ((uint32_t)0x00000000);							
   
  ETH_InitStruct->ETH_AddressAlignedBeats = ((uint32_t)0x02000000);						
   
  ETH_InitStruct->ETH_FixedBurst = ((uint32_t)0x00010000);    												
   
  ETH_InitStruct->ETH_RxDMABurstLength = ((uint32_t)0x00400000);    
  ETH_InitStruct->ETH_TxDMABurstLength = ((uint32_t)0x00002000);    
   
  ETH_InitStruct->ETH_DescriptorSkipLength = 0x0; 
   
  ETH_InitStruct->ETH_DMAArbitration = ((uint32_t)0x00000000);
}
...
uint32_t ETH_Init(ETH_InitTypeDef* ETH_InitStruct, uint16_t PHYAddress)
{
  ...
  ETH_Delay(((uint32_t)0x000FFFFF));
    
  if(ETH_InitStruct->ETH_AutoNegotiation != ((uint32_t)0x00000000))
  {  
     
    do
    {
      timeout++;
    } while (!(ETH_ReadPHYRegister(PHYAddress, 1) & ((uint16_t)0x0004)) && (timeout < ((uint32_t)0x00013FFF)));

     
    if(timeout == ((uint32_t)0x00013FFF))
    {
      return ((uint32_t)0);
    }
    ...
    {
      timeout++;
    } while (!(ETH_ReadPHYRegister(PHYAddress, 1) & ((uint16_t)0x0020)) && (timeout < (uint32_t)((uint32_t)0x00013FFF)));  
    ...
    RegValue = ETH_ReadPHYRegister(PHYAddress, ((uint16_t)17));
  
     
    if((RegValue & ((u16)0xA000)) != (uint32_t)RESET)
    {
    ...
    else
    {
      ...
      ETH_InitStruct->ETH_Mode = ((uint32_t)0x00000000);           
    }

     
    if(RegValue & ((u16)0x3000))
    {  
           
      ETH_InitStruct->ETH_Speed = ((uint32_t)0x00000000); 
    }
    else
    {   
  ...
  {
    if(!ETH_WritePHYRegister(PHYAddress, 0, ((uint16_t)(ETH_InitStruct->ETH_Mode >> 3) |
  ...
  ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MACFFR = (uint32_t)(ETH_InitStruct->ETH_ReceiveAll | 
  ...
  ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MACHTHR = (uint32_t)ETH_InitStruct->ETH_HashTableHigh;
   
  ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MACHTLR = (uint32_t)ETH_InitStruct->ETH_HashTableLow;
  ...
  ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MACVLANTR = (uint32_t)(ETH_InitStruct->ETH_VLANTagComparison | 
  ...
  ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->DMABMR = (uint32_t)(ETH_InitStruct->ETH_AddressAlignedBeats | 
...
FlagStatus ETH_GetFlowControlBusyStatus(void)
{
  ...
  if ((((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MACFCR & ((uint32_t)0x00000001)) != (uint32_t)RESET)
  {
    bitstatus = SET;
  }
  else
...
{ 
  ...
  ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MACFCR |= ((uint32_t)0x00000001);  
}
...
FlagStatus ETH_GetMACFlagStatus(uint32_t ETH_MAC_FLAG)
{
  ...
  ((void)0); 
  if ((((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MACSR & ETH_MAC_FLAG) != (uint32_t)RESET)
  {
    bitstatus = SET;
  }
  else
...
ITStatus ETH_GetMACITStatus(uint32_t ETH_MAC_IT)
{
  ...
  ((void)0); 
  if ((((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MACSR & ETH_MAC_IT) != (uint32_t)RESET)
  {
    bitstatus = SET;
  }
  else
...
void ETH_MACITConfig(uint32_t ETH_MAC_IT, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MACIMR &= (~(uint32_t)ETH_MAC_IT);
  }
  else
  {
     
    ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MACIMR |= ETH_MAC_IT;
  }
}
...
void ETH_GetMACAddress(uint32_t MacAddr, uint8_t *Addr)
{
  ...
  tmpreg =(*(volatile uint32_t *) (((((((uint32_t)0x40000000) + 0x00020000) + 0x8000)) + 0x40) + MacAddr));
 
   
  Addr[5] = ((tmpreg >> 8) & (uint8_t)0xFF);
  Addr[4] = (tmpreg & (uint8_t)0xFF);
   
  tmpreg =(*(volatile uint32_t *) (((((((uint32_t)0x40000000) + 0x00020000) + 0x8000)) + 0x44) + MacAddr));
...
void ETH_MACAddressPerfectFilterCmd(uint32_t MacAddr, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    (*(volatile uint32_t *) (((((((uint32_t)0x40000000) + 0x00020000) + 0x8000)) + 0x40) + MacAddr)) |= ((uint32_t)0x80000000);
  }
  else
  {
     
    (*(volatile uint32_t *) (((((((uint32_t)0x40000000) + 0x00020000) + 0x8000)) + 0x40) + MacAddr)) &=(~(uint32_t)((uint32_t)0x80000000));
  }
}
...
void ETH_MACAddressFilterConfig(uint32_t MacAddr, uint32_t Filter)
{
  ...
  if (Filter != ((uint32_t)0x00000008))
  {
    
 
    (*(volatile uint32_t *) (((((((uint32_t)0x40000000) + 0x00020000) + 0x8000)) + 0x40) + MacAddr)) |= ((uint32_t)0x40000000);
  }
  else
  {
    
 
    (*(volatile uint32_t *) (((((((uint32_t)0x40000000) + 0x00020000) + 0x8000)) + 0x40) + MacAddr)) &=(~(uint32_t)((uint32_t)0x40000000));
  }
}
...
void ETH_MACAddressMaskBytesFilterConfig(uint32_t MacAddr, uint32_t MaskByte)
{
  ...
  (*(volatile uint32_t *) (((((((uint32_t)0x40000000) + 0x00020000) + 0x8000)) + 0x40) + MacAddr)) &=(~(uint32_t)((uint32_t)0x3F000000));
   
  (*(volatile uint32_t *) (((((((uint32_t)0x40000000) + 0x00020000) + 0x8000)) + 0x40) + MacAddr)) |= MaskByte;
}
...
{ 
  ...
  while (((DMARxDescToGet->Status & ((uint32_t)0x80000000)) == (uint32_t)RESET)&&
        (descriptor_scan_counter<5))
  {
    ...
    if(((DMARxDescToGet->Status & ((uint32_t)0x00000200)) != (uint32_t)RESET)&&
    ...
    else if (((DMARxDescToGet->Status & ((uint32_t)0x00000100)) == (uint32_t)RESET)&&
    ...
    { 
      ...
      frame.length = ((DMARxDescToGet->Status & ((uint32_t)0x3FFF0000)) >> 16) - 4;
...
{   
  ...
  if((DMATxDescToSet->Status & ((uint32_t)0x80000000)) != (u32)RESET)
  {  
  ...
  if ((((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->DMASR & ((uint32_t)0x00000004)) != (u32)RESET)
  {
...
uint32_t ETH_GetDMATxDescCollisionCount(ETH_DMADESCTypeDef *DMATxDesc)
{
  ...
  return ((DMATxDesc->Status & ((uint32_t)0x00000078)) >> 3);
}
...
void ETH_SetDMATxDescOwnBit(ETH_DMADESCTypeDef *DMATxDesc)
{
  ...
  DMATxDesc->Status |= ((uint32_t)0x80000000);
}
...
void ETH_DMATxDescTransmitITConfig(ETH_DMADESCTypeDef *DMATxDesc, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    DMATxDesc->Status |= ((uint32_t)0x40000000);
  }
  else
  {
     
    DMATxDesc->Status &=(~(uint32_t)((uint32_t)0x40000000));
  }
}
...
void ETH_DMATxDescCRCCmd(ETH_DMADESCTypeDef *DMATxDesc, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    DMATxDesc->Status &= (~(uint32_t)((uint32_t)0x08000000));
  }
  else
  {
     
    DMATxDesc->Status |= ((uint32_t)0x08000000); 
  }
}
...
void ETH_DMATxDescSecondAddressChainedCmd(ETH_DMADESCTypeDef *DMATxDesc, FunctionalState NewState)
{
  ...
  else
  {
    ...
    DMATxDesc->Status &=(~(uint32_t)((uint32_t)0x00100000)); 
  }
}
...
void ETH_DMATxDescShortFramePaddingCmd(ETH_DMADESCTypeDef *DMATxDesc, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    DMATxDesc->Status &= (~(uint32_t)((uint32_t)0x04000000));
  }
  else
  {
     
    DMATxDesc->Status |= ((uint32_t)0x04000000); 
  }
}
...
void ETH_DMATxDescBufferSizeConfig(ETH_DMADESCTypeDef *DMATxDesc, uint32_t BufferSize1, uint32_t BufferSize2)
{
  ...
  DMATxDesc->ControlBufferSize |= (BufferSize1 | (BufferSize2 << 16));
}
...
uint32_t ETH_GetDMARxDescFrameLength(ETH_DMADESCTypeDef *DMARxDesc)
{
  ...
  return ((DMARxDesc->Status & ((uint32_t)0x3FFF0000)) >> 16);
}
...
void ETH_DMARxDescReceiveITConfig(ETH_DMADESCTypeDef *DMARxDesc, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    DMARxDesc->ControlBufferSize &=(~(uint32_t)((uint32_t)0x80000000));
  }
  else
  {
     
    DMARxDesc->ControlBufferSize |= ((uint32_t)0x80000000);
  }
}
...
uint32_t ETH_GetDMARxDescBufferSize(ETH_DMADESCTypeDef *DMARxDesc, uint32_t DMARxDesc_Buffer)
{
  ...
  if(DMARxDesc_Buffer != ((uint32_t)0x00000000))
  {
     
    return ((DMARxDesc->ControlBufferSize & ((uint32_t)0x1FFF0000)) >> 16); 
  }
  else
  {
     
    return (DMARxDesc->ControlBufferSize & ((uint32_t)0x00001FFF)); 
  }
}
...
{
  uint32_t frameLength = 0;
  if(((DMARxDesc->Status & ((uint32_t)0x80000000)) == (uint32_t)RESET) &&
     ((DMARxDesc->Status & ((uint32_t)0x00008000)) == (uint32_t)RESET) &&
     ((DMARxDesc->Status & ((uint32_t)0x00000100)) != (uint32_t)RESET)) 
  {
...
{
  FlagStatus bitstatus = RESET;
  if((((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->DMABMR & ((uint32_t)0x00000001)) != (uint32_t)RESET)
  {
    bitstatus = SET;
  }
  else
...
{  
  ...
  ((void)0);
  if ((((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->DMASR & ETH_DMA_FLAG) != (uint32_t)RESET)
  {
    bitstatus = SET;
  }
  else
...
void ETH_DMAClearFlag(uint32_t ETH_DMA_FLAG)
{
  ...
  ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->DMASR = (uint32_t) ETH_DMA_FLAG;
}
...
void ETH_DMAITConfig(uint32_t ETH_DMA_IT, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->DMAIER |= ETH_DMA_IT;
  }
  else
  {
     
    ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->DMAIER &=(~(uint32_t)ETH_DMA_IT);
  }
}
...
{  
  ...
  ((void)0);
  if ((((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->DMASR & ETH_DMA_IT) != (uint32_t)RESET)
  {
    bitstatus = SET;
  }
  else
...
void ETH_DMAClearITPendingBit(uint32_t ETH_DMA_IT)
{
  ...
  ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->DMASR = (uint32_t) ETH_DMA_IT;
}
...
uint32_t ETH_GetTransmitProcessState(void)
{
  return ((uint32_t)(((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->DMASR & ((uint32_t)0x00000001))); 
}
...
uint32_t ETH_GetReceiveProcessState(void)
{
  return ((uint32_t)(((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->DMASR & ((uint32_t)0x00000040))); 
}
...
{   
  FlagStatus bitstatus = RESET;
  if ((((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->DMAOMR & ((uint32_t)0x00100000)) != (uint32_t)RESET)
  {
    bitstatus = SET;
  }
  else
...
FlagStatus ETH_GetDMAOverflowStatus(uint32_t ETH_DMA_Overflow)
{
  ...
  if ((((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->DMAMFBOCR & ETH_DMA_Overflow) != (uint32_t)RESET)
  {
    bitstatus = SET;
  }
  else
...
uint32_t ETH_GetRxOverflowMissedFrameCounter(void)
{
  return ((uint32_t)((((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->DMAMFBOCR & ((uint32_t)0x0FFE0000))>>17));
}
...
uint32_t ETH_GetBufferUnavailableMissedFrameCounter(void)
{
  return ((uint32_t)(((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->DMAMFBOCR) & ((uint32_t)0x0000FFFF));
}
...
uint32_t ETH_GetCurrentTxDescStartAddress(void)
{
  return ((uint32_t)(((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->DMACHTDR));
}
...
uint32_t ETH_GetCurrentRxDescStartAddress(void)
{
  return ((uint32_t)(((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->DMACHRDR));
}
...
uint32_t ETH_GetCurrentTxBufferAddress(void)
{
  return ((uint32_t)(((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->DMACHTBAR));
}
...
uint32_t ETH_GetCurrentRxBufferAddress(void)
{
  return ((uint32_t)(((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->DMACHRBAR));
}
...
void ETH_SetReceiveWatchdogTimer(uint8_t Value)
{
  ...
  ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->DMARSWTR = Value;
}
...
volatile uint32_t timeout = 0;
  ...
  do
  {
    timeout++;
    tmpreg = ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MACMIIAR;
  } while ((tmpreg & ((uint32_t)0x00000001)) && (timeout < (uint32_t)((uint32_t)0x00013FFF)));
...
uint32_t ETH_PHYLoopBackCmd(uint16_t PHYAddress, FunctionalState NewState)
{
  ...
  tmpreg = ETH_ReadPHYRegister(PHYAddress, 0); 
  
  if (NewState != DISABLE)
  {
     
    tmpreg |= ((uint16_t)0x4000);  
  }
  else
  {
     
    tmpreg &= (uint16_t)(~(uint16_t)((uint16_t)0x4000));
  }
   
  if(ETH_WritePHYRegister(PHYAddress, 0, tmpreg) != (uint32_t)RESET)
  {
    return ((uint32_t)1);
  }
  else
...
{  
  ...
  ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MACPMTCSR |= ((uint32_t)0x80000000);  
}
...
void ETH_SetWakeUpFrameFilterRegister(uint32_t *Buffer)
{
  ...
  for(i =0; i<8; i++)
  {
    ...
    ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MACRWUFFR = Buffer[i];
  }
}
...
{ 
  ...
  if (NewState != DISABLE)
  {
    ...
    ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MACPMTCSR |= ((uint32_t)0x00000200);  
  }
  else
  {
...
FlagStatus ETH_GetPMTFlagStatus(uint32_t ETH_PMT_FLAG)
{
  ...
  if ((((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MACPMTCSR & ETH_PMT_FLAG) != (uint32_t)RESET)
  {
    bitstatus = SET;
  }
  else
...
{ 
  ...
  if (NewState != DISABLE)
  {
    ...
    ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MACPMTCSR |= ((uint32_t)0x00000004);  
  }
  else
  {
...
{ 
  ...
  if (NewState != DISABLE)
  {
    ...
    ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MACPMTCSR |= ((uint32_t)0x00000002);  
  }
  else
  {
...
{ 
  ...
  if (NewState != DISABLE)
  {
    ...
    ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MACPMTCSR |= ((uint32_t)0x00000001);  
  }
  else
  {
...
void ETH_MMCCounterFullPreset(void)
{
  ...
  ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MMCCR |= ((uint32_t)0x00000020) | ((uint32_t)0x00000010);
}
...
void ETH_MMCCounterHalfPreset(void)
{
  ...
  ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MMCCR &= ~((uint32_t)0x00000020);
   
  ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MMCCR |= ((uint32_t)0x00000010);
}
...
void ETH_MMCCounterFreezeCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MMCCR |= ((uint32_t)0x00000008);
  }
  else
  {
...
void ETH_MMCResetOnReadCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MMCCR |= ((uint32_t)0x00000004); 
  }
  else
  {
...
void ETH_MMCCounterRolloverCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MMCCR &= ~((uint32_t)0x00000002);
  }
  else
  {
...
void ETH_MMCCountersReset(void)
{
  ...
  ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MMCCR |= ((uint32_t)0x00000001); 
}
...
{ 
  ...
  if ((ETH_MMC_IT & (uint32_t)0x10000000) != (uint32_t)RESET)
  {
    ...
    if (NewState != DISABLE)
    {
      ...
      ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MMCRIMR &=(~(uint32_t)ETH_MMC_IT);
    }
    else
    {
       
      ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MMCRIMR |= ETH_MMC_IT;    
    }
  }
  else
  {
    ...
    if (NewState != DISABLE)
    {
      ...
      ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MMCTIMR &=(~(uint32_t)ETH_MMC_IT);
    }
    else
    {
       
      ((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MMCTIMR |= ETH_MMC_IT;    
    }  
  }
}
...
ITStatus ETH_GetMMCITStatus(uint32_t ETH_MMC_IT)
{
  ...
  if ((ETH_MMC_IT & (uint32_t)0x10000000) != (uint32_t)RESET)
  {
    ...
    if ((((((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MMCRIR & ETH_MMC_IT) != (uint32_t)RESET)) && ((((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MMCRIMR & ETH_MMC_IT) == (uint32_t)RESET))
    {
      bitstatus = SET;
    }
    else
  ...
  else
  {
    ...
    if ((((((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MMCTIR & ETH_MMC_IT) != (uint32_t)RESET)) && ((((ETH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x8000))->MMCRIMR & ETH_MMC_IT) == (uint32_t)RESET))
    {
      bitstatus = SET;
    }
    else
...
uint32_t ETH_GetMMCRegister(uint32_t ETH_MMCReg)
{
  ...
  return (*(volatile uint32_t *)((((((uint32_t)0x40000000) + 0x00020000) + 0x8000)) + ETH_MMCReg));
}
