#line 1 "..\\HARDWARE\\ETHERNET\\LAN8720.c"
...
#line 2 "..\\HARDWARE\\ETHERNET\\LAN8720.c"
#line 3 "..\\HARDWARE\\ETHERNET\\LAN8720.c"
...
#line 4 "..\\HARDWARE\\ETHERNET\\LAN8720.c"
...
#line 5 "..\\HARDWARE\\ETHERNET\\LAN8720.c"
...
#line 6 "..\\HARDWARE\\ETHERNET\\LAN8720.c"
...
u8 LAN8720_Init(void)
{
   ...
   ETH_GPIO_Config_RMII(); 
	  ...
	  rval=ETH_MACDMA_Config();
		...
		if(ETH_ReadPHYRegister(((uint16_t) 0x01), ((uint16_t)17)) & 4)
		{
			EthStatus |= 0x10;
		}
...
void MAC_Init(void)
{
    ...
    ETH_MACAddressConfig(((uint32_t)0x00000000), MyMacAddr);
...
u8 ETH_MACDMA_Config(void)
{
	...
	RCC_AHB1PeriphClockCmd(((uint32_t)0x02000000) | ((uint32_t)0x04000000) |((uint32_t)0x08000000), ENABLE);
	...
	ETH_InitStructure.ETH_AutoNegotiation = ((uint32_t)0x00000001);   			
	ETH_InitStructure.ETH_LoopbackMode = ((uint32_t)0x00000000);					
	ETH_InitStructure.ETH_RetryTransmission = ((uint32_t)0x00000200); 		
	ETH_InitStructure.ETH_AutomaticPadCRCStrip = ((uint32_t)0x00000000); 	
	ETH_InitStructure.ETH_ReceiveAll = ((uint32_t)0x80000000);						
	ETH_InitStructure.ETH_BroadcastFramesReception = ((uint32_t)0x00000000);
	ETH_InitStructure.ETH_PromiscuousMode = ((uint32_t)0x00000000);			
	ETH_InitStructure.ETH_MulticastFramesFilter = ((uint32_t)0x00000000);
	ETH_InitStructure.ETH_UnicastFramesFilter = ((uint32_t)0x00000000);	
	ETH_InitStructure.ETH_ChecksumOffload = ((uint32_t)0x00000400); 			
	
	
	ETH_InitStructure.ETH_DropTCPIPChecksumErrorFrame = ((uint32_t)0x00000000); 
	ETH_InitStructure.ETH_ReceiveStoreForward = ((uint32_t)0x02000000);     
	ETH_InitStructure.ETH_TransmitStoreForward = ((uint32_t)0x00200000);   

	ETH_InitStructure.ETH_ForwardErrorFrames = ((uint32_t)0x00000000);     	
	ETH_InitStructure.ETH_ForwardUndersizedGoodFrames = ((uint32_t)0x00000000);	
	ETH_InitStructure.ETH_SecondFrameOperate = ((uint32_t)0x00000004);  		
	ETH_InitStructure.ETH_AddressAlignedBeats = ((uint32_t)0x02000000);  	
	ETH_InitStructure.ETH_FixedBurst = ((uint32_t)0x00010000);            			
	ETH_InitStructure.ETH_RxDMABurstLength = ((uint32_t)0x00400000);     		
	ETH_InitStructure.ETH_TxDMABurstLength = ((uint32_t)0x00002000);			
	ETH_InitStructure.ETH_DMAArbitration = ((uint32_t)0x00004000);
	rval=ETH_Init(&ETH_InitStructure,((uint16_t) 0x01));		
	EthStatus=rval;
...
{ 
	...
	if((DMARxDescToGet->Status&((uint32_t)0x80000000))!=(u32)RESET)
	{	
		frame.length=((uint32_t)0); 
	...
	if(((DMARxDescToGet->Status&((uint32_t)0x00008000))==(u32)RESET)&& 
	((DMARxDescToGet->Status & ((uint32_t)0x00000100))!=(u32)RESET)&&  
	((DMARxDescToGet->Status & ((uint32_t)0x00000200))!=(u32)RESET))  
	{       
		framelength=((DMARxDescToGet->Status&((uint32_t)0x3FFF0000))>>16)-4;
 		frame.buffer = DMARxDescToGet->Buffer1Addr;
	}else framelength=((uint32_t)0);
...
{   
	...
	if((DMATxDescToSet->Status&((uint32_t)0x80000000))!=(u32)RESET)return ((uint32_t)0);
 	DMATxDescToSet->ControlBufferSize=(FrameLength&((uint32_t)0x00001FFF));
	DMATxDescToSet->Status|=((uint32_t)0x20000000)|((uint32_t)0x10000000);
...
static void ETH_GPIO_Config_RMII(void)
{
	...
	RCC_AHB1PeriphClockCmd(((uint32_t)0x00000001) | ((uint32_t)0x00000004) | ((uint32_t)0x00000040) |
	                     ((uint32_t)0x00000080), ENABLE);

	 
	RCC_APB2PeriphClockCmd(((uint32_t)0x00004000), ENABLE);

	SYSCFG_ETH_MediaInterfaceConfig(((uint32_t)0x00000001));
	...
	GPIO_InitStructure.GPIO_Pin = ((uint16_t)0x0002) | ((uint16_t)0x0004) | ((uint16_t)0x0080);
	GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), &GPIO_InitStructure);

	GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint8_t)0x01), ((uint8_t)0x0B));
	GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint8_t)0x02), ((uint8_t)0x0B));
	GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint8_t)0x07), ((uint8_t)0x0B));

	 
	GPIO_InitStructure.GPIO_Pin = ((uint16_t)0x0002) | ((uint16_t)0x0010) | ((uint16_t)0x0020);
	GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800)), &GPIO_InitStructure);
	GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800)), ((uint8_t)0x01), ((uint8_t)0x0B));
	GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800)), ((uint8_t)0x04), ((uint8_t)0x0B));
	GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800)), ((uint8_t)0x05), ((uint8_t)0x0B));

	 
	GPIO_InitStructure.GPIO_Pin =  ((uint16_t)0x0800) | ((uint16_t)0x2000) | ((uint16_t)0x4000);
	GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1800)), &GPIO_InitStructure);
	GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1800)), ((uint8_t)0x0B), ((uint8_t)0x0B));
	GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1800)), ((uint8_t)0x0D), ((uint8_t)0x0B));
	GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1800)), ((uint8_t)0x0E), ((uint8_t)0x0B));
}
...
void Eth_Link_EXTIConfig(void)
{
  ...
  SYSCFG_EXTILineConfig(((uint8_t)0x01), ((uint8_t)0x0E));
...
void Eth_Link_ITHandler(uint16_t PHYAddress)
{
  ...
  if(((ETH_ReadPHYRegister(PHYAddress, ((uint16_t)0x15))) & ((uint16_t)0x0200)) != 0)
  {
		tesh++;
    if((ETH_ReadPHYRegister(PHYAddress, ((uint16_t)17)) & 1))
    {
