...
ErrorStatus RTC_Set_Time(u8 hour,u8 min,u8 sec,u8 ampm)
{
	...
	return RTC_SetTime(((uint32_t)0x000000000),&RTC_TimeTypeInitStructure);
...
ErrorStatus RTC_Set_Date(u8 year,u8 month,u8 date,u8 week)
{
	...
	return RTC_SetDate(((uint32_t)0x000000000),&RTC_DateTypeInitStructure);
}
...
u8 My_RTC_Init(void)
{
  ...
  RCC_APB1PeriphClockCmd(((uint32_t)0x10000000), ENABLE);
	...
	if(RTC_ReadBackupRegister(((uint32_t)0x00000000))!=0x5050)		
	{
    ...
    RTC_Init(&RTC_InitStructure);
		...
		RTC_Set_Time(23,59,56,((uint8_t)0x00));	
		RTC_Set_Date(14,5,5,6);		
	 
		RTC_WriteBackupRegister(((uint32_t)0x00000000),0x5050);	
	} 
...
{ 
  ...
  RTC_TimeTypeInitStructure.RTC_Hours=hour;
	RTC_TimeTypeInitStructure.RTC_Minutes=min;
	RTC_TimeTypeInitStructure.RTC_Seconds=sec;
	RTC_TimeTypeInitStructure.RTC_H12=((uint8_t)0x00);
  
	RTC_AlarmTypeInitStructure.RTC_AlarmDateWeekDay=week;
	RTC_AlarmTypeInitStructure.RTC_AlarmDateWeekDaySel=((uint32_t)0x40000000);
	RTC_AlarmTypeInitStructure.RTC_AlarmMask=((uint32_t)0x00000000);
	RTC_AlarmTypeInitStructure.RTC_AlarmTime=RTC_TimeTypeInitStructure;
  RTC_SetAlarm(((uint32_t)0x000000000),((uint32_t)0x00000100),&RTC_AlarmTypeInitStructure);
...
{ 
  ...
  EXTI_ClearITPendingBit(((uint32_t)0x00400000));
	 
	RTC_ITConfig(((uint32_t)0x00004000),ENABLE);
	RTC_WakeUpCmd( ENABLE);
	
	EXTI_InitStructure.EXTI_Line = ((uint32_t)0x00400000);
  EXTI_InitStructure.EXTI_Mode = EXTI_Mode_Interrupt;
  EXTI_InitStructure.EXTI_Trigger = EXTI_Trigger_Rising; 
  EXTI_InitStructure.EXTI_LineCmd = ENABLE;
  EXTI_Init(&EXTI_InitStructure);
...
{    
	if(RTC_GetFlagStatus(((uint32_t)0x00000100))==SET)
	{
...
{    
	if(RTC_GetFlagStatus(((uint32_t)0x00000400))==SET)
	{ 
		RTC_ClearFlag(((uint32_t)0x00000400));	
		*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x00020000) + 0x1400)+20) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x00020000) + 0x1400)+20) &0xFFFFF)<<5)+(10<<2))))=! *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x00020000) + 0x1400)+20) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x00020000) + 0x1400)+20) &0xFFFFF)<<5)+(10<<2)))); 
	}   
	EXTI_ClearITPendingBit(((uint32_t)0x00400000));
}
